...
public class SCRSImplTest {
    ...
    @Test
    public void testQueryStudentPersonalDataByStudent() throws Exception {
        ArrayList<String> alist = new ArrayList<>();
        alist.add("0");
        alist.add("Jack");
        alist.add("Stark");
    ...
    @Test
    public void testQueryStudentPersonalDataByStudentByAdmin() throws Exception {
        ArrayList<String> alist = new ArrayList<>();
        alist.add("0");
        alist.add("Jack");
        alist.add("Stark");
    ...
    @Test
    public void testQueryStudentRegistrationHistoryByStudent() throws Exception {
        ArrayList<String> alist = new ArrayList<>();
        alist.add("1");
        alist.add("1");
        alist.add("AUD");
    ...
    @Test
    public void testQueryStudentRegistrationHistoryByAdmin() throws Exception {
        ArrayList<String> alist = new ArrayList<>();
        alist.add("1");
        alist.add("1");
        alist.add("AUD");
    ...
    @Test
    public void testQueryInstructorByStudent() throws Exception {
        ArrayList<String> alist = new ArrayList<>();
        alist.add("0");
        alist.add("Stark");
        alist.add("Joshua");
    ...
    @Test
    public void testQueryInstructorByAdmin() throws Exception {
        ArrayList<String> alist = new ArrayList<>();
        alist.add("0");
        alist.add("Stark");
        alist.add("Joshua");
